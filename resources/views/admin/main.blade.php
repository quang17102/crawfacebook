...
<body class="hold-transition sidebar-mini">
    ...
    {{-- common --}}
    <script src="/js/common/index.js?v=11111133"></script>
    ...
    <script>
        ...
        $(document).on('click', '.show-title', function() {
            ...
            var linkkk = link_or_post_id.toString().replace(/\s/g, '');
            window.open(`https://www.facebook.com/${linkkk}`, '_blank').focus();
        });
        ...
        $(document).on('click', '.show-history', async function() {
            ...
            await $.ajax({
                type: "GET",
                url: `/api/linkHistories/getHistoryAll?link_or_post_id=${link_or_post_id}&type=-1`,
