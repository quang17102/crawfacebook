...
@endpush
@push('scripts')
    <script src="/js/user/linkscan/index.js?v=11111111111111311"></script>
...
@section('content')
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title_second"
                                        value="{{$user["name"]}}" placeholder="Nhập tên bài viêt">
                                </div>
                                <div class="form-group">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card direct-chat direct-chat-primary">
                <div class="card-header ui-sortable-handle header-color" style="cursor: move;">
                    <h3 class="card-title text-bold">Danh sách link quétt</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                            <i class="fas fa-minus"></i>
                        </button>
                ...
                <div class="card-body" style="display: block;padding: 10px !important;">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <button data-is_scan="0" class="btn-control btn btn-danger btn-scan-multiple">OFF</button>
                        <button data-is_scan="1" class="btn-control btn btn-success btn-scan-multiple">ON</button>
