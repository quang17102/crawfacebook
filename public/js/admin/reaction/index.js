...
$(document).ready(function () {
    ...
    dataTable = $("#table").DataTable({
        ...
        columns: [
            ...
            {
                data: function (d) {
                    return `<p class="show-title-comment tool-tip" data-type='content' data-content="${d.content}" data-link_or_post_id="${d.link ? d.link.link_or_post_id : ''}" data-id="${d.id}">${d.link ? d.link.title : ''}
